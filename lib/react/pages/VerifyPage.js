...
var _require = require('transactions-interface-state'),
    apiFetch = _require.apiFetch,
    setActiveUser = _require.setActiveUser;
...
var VerifyPage = function (_Component) {
  ...
  _createClass(VerifyPage, [{
    ...
    value: function componentDidMount() {
      ...
      var setActiveUser = this.props.setActiveUser;
      ...
      apiFetch(_apis.SIGN_PATH + '/activate-account', {
        method: 'post',
...
exports.default = (0, _reactRedux.connect)(null, { setActiveUser: setActiveUser })(VerifyPage);