...
var ToursSection = function ToursSection(_ref) {
  var IS_DEVELOPMENT = _ref.IS_DEVELOPMENT,
      path = _ref.path,
      slides = _ref.slides;
  ...
  return _react2.default.createElement(
    ...
    IS_DEVELOPMENT ? _react2.default.createElement(
      'div',
      null,
      ...
      _react2.default.createElement(_TourSlide2.default, _extends({}, slides.find(function (_ref2) {
        var modeName = _ref2.modeName;
        return modeName === 'reviewer';
      }), {
        path: path,
        text: 'take a tour' }))
    )
